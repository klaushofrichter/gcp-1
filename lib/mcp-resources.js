...
export function registerMcpResources(server, quotesData, serverType = '') {
  ...
  server.registerResource(
    ...
    async () => {
      console.error(`Random quote requested via ${logPrefix}`);
  ...
  server.registerResource(
    ...
    async () => {
      console.error(`Text format requested via ${logPrefix}`);
...
export function registerMcpTools(server, quotesData, serverType = '', quoteSuffix = '') {
  ...
  server.registerTool(
    ...
    async ({ character }) => {
      console.error(`Get quote by character tool called via ${logPrefix}:`, character);
  ...
  server.registerTool(
    ...
    async () => {
      console.error(`Random quote tool called via ${logPrefix}`);
      const randomQuote = getRandomQuote(quotesData);
